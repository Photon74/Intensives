...
namespace Laboratory4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] y;
            int[] l;
            Initialize(out width, out heigth, out y, out l);
            int ms;
            ...
            while (true)
            {
                ...
                MatrixStep(width, heigth, y, l);
                ms = 50 - (int)((TimeSpan)(DateTime.Now - t1)).TotalMilliseconds;
            ...
            // Пример с сайта https://www.cyberforum.ru/csharp-beginners/thread373269.html
            #endregion
        }
